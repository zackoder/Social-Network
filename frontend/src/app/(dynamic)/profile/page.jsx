...
export default function ProfilePage() {
    ...
    const fetchProfileData = async () => {
        ...
        try {
            ...
            const profileResponse = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/profile?id=${profileId}`, {
                credentials: 'include',
            });
            ...
            // Fetch posts
            const postsResponse = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/profilePosts?id=${profileId}`, {
                credentials: 'include',
            });
            ...
            // Fetch followers
            const followersResponse = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/followers?id=${profileId}`, {
                credentials: 'include',
            });
            ...
            // Fetch following
            const followingResponse = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/following?id=${profileId}`, {
                credentials: 'include',
            });
    ...
    const handlePrivacyToggle = async () => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_HOST}/api/togglePrivacy`, {
                method: 'POST',
                credentials: 'include',
                headers: {
